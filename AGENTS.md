...
This repository also keeps root `plans/` — dated implementation plans for past
work (e.g. `plans/260805-1837-.../`), separate from Harness's own
`docs/plans/`. Both conventions coexist; do not merge or migrate one into the
other without explicit instruction.
